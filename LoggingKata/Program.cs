...
namespace LoggingKata
{
    class Program
    {
        ...
        public static object corA { get; private set; }
        ...
        static void Main(string[] args)
        {
            ...
            ITrackable tacoBallOne = null;
            ITrackable tacoballTwo = null;
            ...
            Console.WriteLine($"The farthest Taco Bell locations are:");
            Console.WriteLine($"Location A: {tacoBallOne.Name} at ({tacoBallOne.Location.Latitude}, {tacoBallOne.Location.Longitude})");
            Console.WriteLine($"Location B: {tacoballTwo.Name} at ({tacoballTwo.Location.Latitude}, {tacoballTwo.Location.Longitude})");
        }
